...
<%@ page import="com.mirum.form.submission.internal.action.exceptions.MembershipCheckException" %><%@
page import="com.mirum.form.submission.internal.action.exceptions.OTPCheckException" %>
<%@
page import="com.liferay.portal.kernel.language.LanguageUtil" %>

<liferay-ui:error exception="<%= MembershipCheckException.class %>" message="membership-verification-failed" />
<liferay-ui:error exception="<%= OTPCheckException.class %>" message="otp-verification-failed" />
