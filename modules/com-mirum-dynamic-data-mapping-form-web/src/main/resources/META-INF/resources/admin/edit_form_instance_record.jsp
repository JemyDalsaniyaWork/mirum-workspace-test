...
<clay:container-fluid>
	<c:if test="<%= ddmFormInstanceRecordVersion != null %>">
		...
		<div class="panel text-center">
		    <c:choose>
                <c:when test ="<%= ddmFormInstanceRecordVersion.getStatus() == 100 %>">
                    <span class="taglib-workflow-status">
                        <span class="mr-2 workflow-version">
                            <span class="workflow-label">Version:</span>
                            <span class="workflow-value"><%= ddmFormInstanceRecordVersion.getVersion() %></span>
                        </span>
                ...
                <c:when test = "<%= ddmFormInstanceRecordVersion.getStatus() == 101 %>">
                    <span class="taglib-workflow-status">
                        <span class="mr-2 workflow-version">
                            <span class="workflow-label">Version:</span>
                            <span class="workflow-value"><%= ddmFormInstanceRecordVersion.getVersion() %></span>
